...
limite     = int(input("Informe a valor do limite:"))
valor_multa= float(input("Informe o valor da multa:"))
valor_adicional= float(input("Informe o valor adicional da multa:"))
velocidade = int(input("Informe o valor da velocidade:"))

VelocidadeBaixa =0

if velocidade <= limite:
    print("{:.2f}".format(VelocidadeBaixa))
else:  
